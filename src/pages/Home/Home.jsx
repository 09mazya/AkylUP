      ...
      <div className="blockTwo">
        <div className="blockTwo-container">
          <div className="chapter courses">
            ...
            <p>Курсы</p>
            <span>Навыки, адаптированные к потребностям государственными служащими 21 века</span>
          </div>
          <div className="chapter articles">
            ...
            <p>Статьи</p>
            <span>Делитесь своими мыслями и учитесь у коллег</span>
          </div>
          <div className="chapter events">
            ...
            <p>События</p>
            <span>Интерактивные онлайн-семинары с государственными служащими по всему миру</span>
          </div>
          <div className="chapter qa">
            ...
            <span>Найдите государственных служащих, решающих те же вопросы</span>
          </div>
        </div>
      </div>


      <div className="wish blockTree" id="wishlist">
        <div className="wishlist-rus">
          <h2>Мероприятия и курсы</h2>
        </div>
