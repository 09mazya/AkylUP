			...
			<div className="home-main">
				<div className="main-headline">
					...
					<div className="main-text">
						<p>
							<b>25,000 +</b> ежедневных активных пользователей
						</p>
						<p>
							<b>150,000 +</b> курсов и мероприятий
						</p>
					</div>
				</div>
				...
				<div className="home-courses">
					{data.map((item) => (
						<div className="home-courses-content">
							...
							<p className="home-courses-content-title">
								{item.title}
							</p>
			...
			<div className="testimonial">
				<div className="left">
					<div className="test-text">
						<p>“</p>
						<h4>
							Я считаю, что akylup постоянно имеет представление
							об авангарде инновационного правительства и
							потенциале государственного сектора для
